...
namespace ReimbursementTrackerApp.Interfaces
{
    ...
    public interface IRequestService
    {
        ...
        /// <returns>A collection of Requests matching the specified category.</returns>
        ...
        /// <returns>A collection of Requess associated with the specified username.</returns>
        public IEnumerable<Request> GetRequestsByUsername(string username);

        /// <summary>
        /// Retrieves all requests.
        /// </summary>
        /// <returns>A collection of all Requess.</returns>
